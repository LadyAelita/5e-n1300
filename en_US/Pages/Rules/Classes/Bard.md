...
| ------ | ----------------- | --------------------------------------------------- | ---------------------- | -------------- | ------------ | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
| **1**  | **+2 (up)**       | Spellcasting, Bardic Inspiration                    | **d6 (up)**            | 2              | 4            | **2** | -     | -     | -     | -     | -     | -     | -     | -     |
| **2**  | +2                | Jack of All Trades, Song of Rest (d6)               | d6                     | 2              | 5            | **3** | -     | -     | -     | -     | -     | -     | -     | -     |
| **3**  | +2                | Expertise, *Subclass Feature I*                     | d6                     | 2              | 6            | **4** | **2** | -     | -     | -     | -     | -     | -     | -     |
...
| **17** | **+6 (up)**       | Song of Rest (d12)                                  | d12                    | 4              | 16           | 4     | 3     | 3     | 3     | 2     | 1     | 1     | 1     | **1** |
