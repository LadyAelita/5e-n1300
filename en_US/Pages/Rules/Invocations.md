[gimmick:title](Eldritch Invocations)
...
### Blast Shape Least Invocations

| Invocation            | Description                                                  | Patron           |
| --------------------- | ------------------------------------------------------------ | ---------------- |
| **Agonizing Blast**   | You add your Charisma modifier to the damage you deal with every individual blast. | -                |
| **Eldritch Spear**    | The range of your *Eldritch Blast* is 300 feet.              | -                |
| **Kaelyn's Blessing** | When you score a critical hit with *Eldritch Blast*, pick yourself or an ally you can see within 30 feet of you. The target can instantly expend a Hit Die to heal itself. | Archfey, Undying |
...
### General Least Invocations

| Invocation                       | Description                                                  | Patron        |
| -------------------------------- | ------------------------------------------------------------ | ------------- |
| **Ariel's Beauty**               | Once a day, you can get advantage on Charisma ability checks, but disadvantage on Wisdom ability checks. When activated, this lasts until the next rest. | Archfey       |
| **Aspect of the Moon**           | You no longer need to sleep and can't be forced to sleep by any means. To gain the benefits of a long rest, you can spend all 8 hours doing light activity, such as reading your Book of Shadows and keeping watch. | Archfey       |
| **Awaken from the Dark Slumber** | *You harness the vital essence of Spring.* Whenever you regain hit points, you treat any dice rolled to determine the hit points you regain as having rolled their maximum value. | Archfey       |
| **Beguiling Influence**          | You gain proficiency in Deception and Persuasion. If you're already proficient, you gain expertise instead. | -             |
| **Belial's Deceit**              | Once a day, you can get advantage on Deception checks but disadvantage on Insight and Perception checks. When activated, this lasts until the next rest. | Fiend         |
| **Blood Magic**                  | Twice a day, you can sacrifice 1d6 + twice your Warlock level hit points instead of expending a spell slot. | Fiend         |
| **Devil's Sight**                | You see normally in darkness, both magical and natural, to a distance of 120 feet. | -             |
...
| **Guiding Light**                | Once a day you can give yourself advantage on a Survival check. | Aeonian Flame |
| **Moon Bow**                     | You can create a longbow using your Pact of the Blade feature. When you draw back its string and fire, it creates an arrow of white wood, which vanishes after 1 minute. You have advantage on attack rolls against lycanthropes with the bow. When you hit a creature with it, you can expend a spell slot to deal an additional 2d8 radiant damage to the target per spell level. | -             |
| **Path of the Seeker**           | *The Seeker bids you to travel in search of knowledge, and little can prevent you from walking this path.* You ignore difficult terrain, have advantage on all checks to escape a grapple, manacles, or rope bindings, and advantage on saving throws against being paralyzed. | Seeker        |
| **Seeker's Speech**              | *Your quest for knowledge allows you to master any spoken language.* When  you complete a long rest, you can pick two languages. You gain the  ability to speak, read, and write the chosen languages until you finish  your next long rest. | Seeker        |
...
### General Greater Invocations

| Invocation             | Description                                                  | Pact  | Patron         |
| ---------------------- | ------------------------------------------------------------ | ----- | -------------- |
| **Crescent Blade**     | You can create a curved longsword using your Pact of the Blade feature. You choose if it's a finesse weapon or not.<br />If you hit the same target with this weapon at least twice in one turn, you can use your bonus action to instantly deal 1d8 + your Charisma modifier radiant damage to that target. | Blade | Archfey        |
...
| **Dreadful Word**        | Whenever you cast a spell that has a verbal component, the targets that are hit with it, can hear you and have failed the saving throw (if there is one), suffer a level of fear that lasts for the next minute. | -    | -      |
| **Hell-bent**            | Whenever you cast *hex* or otherwise put a curse on the target, the curse creates a bond between you and them. As a bonus action, you can teleport up to 30 feet to an unoccupied space you can see within 5 feet of the target cursed, provided that you can see them. | -    | -      |
...
| **Shroud of Shadow**          | *Invisibility* at will.                                      | -     | -      |
...
| **Sovereign's Decree**  | Whenever you hit somebody with an *eldritch blast*, you can expend a spell slot to cast **supernatural** *immolation* on the creature you have hit (you don't need to know the spell). That creature automatically fails the saving throw. | -    | Fiend  |
